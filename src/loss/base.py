...
class SASRecLoss(BaseLoss):
    ...
    def forward(self, inputs):
        positive_scores = inputs['positive_scores']  # (x)
        negative_scores = inputs['negative_scores']  # (x)
...
class SamplesSoftmaxLoss(BaseLoss):
    def __init__(
        self,
        queries_prefix,
        positive_prefix,
